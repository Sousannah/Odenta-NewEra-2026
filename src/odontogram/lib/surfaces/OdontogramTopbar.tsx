...
// Odenta: the full translation table stays intact; the host decides which of
// its locales the language menu offers (see `src/odontogram/config.js`).
import { VISIBLE_LANGUAGES } from "../../config";
...
].filter((opt) => (VISIBLE_LANGUAGES as string[]).includes(opt.value));
