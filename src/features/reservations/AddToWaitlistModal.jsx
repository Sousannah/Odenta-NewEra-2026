...
function StepTreatment({ form, update, treatments, dentists }) {
...
export function AddToWaitlistModal({ open, onClose, preset, onCreated }) {
  ...
  return (
    ...
    >
      ...
      {step === 1 ? (
        <StepTreatment form={form} update={update} treatments={treatments} dentists={dentists} />
      ) : null}
